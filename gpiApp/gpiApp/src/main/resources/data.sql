    # SELECT * FROM task_management_db.allusers;
    #
    ...
    INSERT INTO allUsers (user_id, email, password_hash, first_name, last_name, phone, profile_picture_url, user_role, user_post, is_active, email_verified_at, last_login_at, created_at, updated_at, dtype) VALUES

    -- Super Admin
    (1, 'admin@jdcosmetics.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
     'John', 'Admin', '+1234567890', 'https://example.com/profiles/admin.jpg', 'SUPER_ADMIN',
     'OPERATIONS_MANAGER', true, NOW(), NOW(), NOW(), NOW(), 'SUPER_ADMIN'),

    -- Managers
    (2, 'manager1@jdcosmetics.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
     'Sarah', 'Manager', '+1234567891', 'https://example.com/profiles/manager1.jpg', 'MANAGER',
     'PROJECT_MANAGER', true, NOW(), NOW(), NOW(), NOW(), 'MANAGER'),

    (3, 'manager2@jdcosmetics.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
     'Michael', 'TeamLead', '+1234567892', 'https://example.com/profiles/manager2.jpg', 'MANAGER',
     'TEAM_LEAD', true, NOW(), NOW(), NOW(), NOW(), 'MANAGER'),

    -- Employees
    (4, 'developer1@jdcosmetics.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
     'Alice', 'Developer', '+1234567893', 'https://example.com/profiles/dev1.jpg', 'EMPLOYEE',
     'DEVELOPER', true, NOW(), NOW(), NOW(), NOW(), 'EMPLOYEE'),

    (5, 'developer2@jdcosmetics.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
     'Bob', 'Coder', '+1234567894', 'https://example.com/profiles/dev2.jpg', 'EMPLOYEE', 'DEVELOPER',
     true, NOW(), NOW(), NOW(), NOW(), 'EMPLOYEE'),

    (6, 'designer1@jdcosmetics.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
     'Emma', 'Designer', '+1234567895', 'https://example.com/profiles/designer1.jpg', 'EMPLOYEE',
     'UI_UX_DESIGNER', true, NOW(), NOW(), NOW(), NOW(), 'EMPLOYEE'),

    (7, 'tester1@jdcosmetics.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
     'David', 'Tester', '+1234567896', 'https://example.com/profiles/tester1.jpg', 'EMPLOYEE', 'QA_ENGINEER',
     true, NOW(), NOW(), NOW(), NOW(), 'EMPLOYEE');
    #
    -- Insert Teams
