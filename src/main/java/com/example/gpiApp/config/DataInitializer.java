...
//         if (!userRepository.existsByEmail("pm@system.com")) {
//             userRepository.findByUsername("projectmanager").ifPresent(userRepository::delete);
...
//         if (!userRepository.existsByEmail("user@system.com")) {
